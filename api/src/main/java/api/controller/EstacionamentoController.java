...
import api.dto.PageableDto;
import api.dto.mapper.ClienteVagaMapper;
import api.dto.mapper.PageableMapper;
import api.entity.ClienteVaga;
import api.exception.ErrorMessage;
import api.repository.projection.ClienteVagaProjection;
import api.security.jwt.JwtUserDetails;
import api.service.ClienteVagaService;
import api.service.EstacionamentoService;
...
public class EstacionamentoController {
    ...
    public ResponseEntity<EstacionamentoResponseDto> checkin(@RequestBody @Valid EstacionamentoCadastroDto dto) {
